  ...
  return (
    <header className="flex justify-between bg-[url('/Design/head-grid.png')] bg-cover py-[16px] items-center">
      ...
      <div className="tg-btn flex">
        ...
        >
          <div className="flex items-center gap-[4px] text-neutral-20 uppercase text-sup font-semibold relative pb-[6px] group-hover:text-primary-yellow transition-colors duration-300">
            <span>Telegram</span>
